...
// ModIndirectPackage return the first indirect mod from any module file.
func ModIndirectModule(modFile string) (mod module.Version, err error) {
	...
	return module.Version{}, errors.New("indirect module not found")
}
