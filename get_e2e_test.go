			...
			if ok := t.Run(fmt.Sprintf("isGoProject=%v", isGoProject), func(t *testing.T) {
				...
				for _, tcase := range []struct {
					...
					},
					{
						...
						do: func(t *testing.T) {
							fmt.Println(g.ExecOutput(t, p.root, goBinPath, "get", "-no-suffix", "buildable"))
					...
					},
					{
						...
						do: func(t *testing.T) {
							fmt.Println(g.ExecOutput(t, p.root, goBinPath, "get", "-no-suffix", "buildable@v0.0.0-20210109093942-2e6391144e85"))
